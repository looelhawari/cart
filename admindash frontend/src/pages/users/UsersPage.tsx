        ...
        <div className="space-y-6" dir={isRTL ? 'rtl' : 'ltr'}>
            <div className={`flex items-center justify-between ${isRTL ? 'flex-row-reverse' : ''}`}>
                <div className={isRTL ? 'text-right' : ''}>
                    <h1 className="text-3xl font-bold text-elbaraka-primary">{t('users.title')}</h1>
                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="border-b">
                                        <th className={`${isRTL ? 'text-right' : 'text-left'} p-3`}>{t('users.name')}</th>
                                        <th className={`${isRTL ? 'text-right' : 'text-left'} p-3`}>{t('users.email')}</th>
                                        <th className={`${isRTL ? 'text-right' : 'text-left'} p-3`}>{t('users.phone')}</th>
                                        <th className={`${isRTL ? 'text-right' : 'text-left'} p-3`}>{t('users.role')}</th>
                                        <th className={`${isRTL ? 'text-right' : 'text-left'} p-3`}>{t('common.status')}</th>
                                        <th className={`${isRTL ? 'text-right' : 'text-left'} p-3`}>{t('users.lastLogin')}</th>
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        type="password"
                                        {...register('password_confirmation', { required: !editingUser })}
                                    />
                                </div>
                            </div>
                        )}
                        <div>
                            ...
                            <Select onValueChange={(value) => setValue('role', value)} defaultValue={editingUser?.role}>
                                ...
                                <SelectContent>
                                    ...
                                    <SelectItem value="sales_manager">{t('users.roles.salesManager')}</SelectItem>
                                    <SelectItem value="accountant">{t('users.roles.accountant')}</SelectItem>
                                    <SelectItem value="customer_support">{t('users.roles.customerSupport')}</SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
