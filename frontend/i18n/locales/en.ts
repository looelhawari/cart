...
export default {
  ...
  signup: {
    ...
    addressOptionalSubtitle:
      "Add a delivery address now, or skip it and add one before checkout.",
    addAddressNow: "Add address now",
    skipAddressHelper: "Optional. You can add or edit addresses later.",
    skipAddressButton: "Skip for now",
    skipAddressConfirmation:
      "No problem. You can add your delivery address later from checkout or profile.",
    addressLabel: "Address Type",
    home: "Home",
    work: "Work",
    streetAddress: "Street Address",
    enterStreetAddressPlaceholder: "Street name and delivery details",
    city: "City",
    enterCityPlaceholder: "Cairo",
    area: "Area",
    enterAreaPlaceholder: "Nasr City",
    building: "Building",
  ...
  checkout: {
    ...
    cardMachineDescription:
      "Driver will bring a portable card machine. Pay by card when your order arrives.",
    cardMachineFeatureBring: "Driver brings a portable card machine",
    cardMachineFeaturePayOnArrival: "Pay by card when your order arrives",
    cardMachineFeatureNoOnlineCharge: "No online charges before delivery",
    ...
    payByCardMachineOnArrival: "Pay by card machine when you receive",
    deliverNow: "Now",
    deliverNowSubtitle: "ASAP",
  ...
  ui: {
    ...
    lastUpdated: "Last updated: ",
    contactEmail:
      "If you have any questions, please contact us at Cart.shopegy@gmail.com",
    // Profile extras
