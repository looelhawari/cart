      ...
      <View style={styles.body}>
        ...
        <View style={styles.badgeWrapper}>
          <LinearGradient
            ...
            style={styles.badge}
          >
            <Text style={styles.badgeText}>{t.orderTracking.comingSoon}</Text>
          </LinearGradient>
        </View>
        <Text style={styles.title}>{t.orderTracking.liveOrderTracking}</Text>
        <Text style={styles.subtitle}>
          {t.orderTracking.buildingExperience}
        </Text>
        <View style={styles.featureRow}>
          {[
            t.orderTracking.liveMap,
            t.orderTracking.pushUpdates,
            t.orderTracking.etaCounter,
          ].map((f) => (
        ...
        <View style={styles.dotsRow}>
          <Text style={styles.dotsLabel}>{t.orderTracking.workingOnIt}</Text>
