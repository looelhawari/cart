...
export default function PromotionProductsScreen() {
  ...
  const renderHeader = () => (
    <View style={styles.headerInfo}>
      ...
      <Text style={styles.resultsCount}>
        {`${products.length} ${t.ui.itemsAvailable}`}
      </Text>
    </View>
  );
  ...
  const renderEmpty = () => (
    <View style={styles.emptyContainer}>
      ...
      <Text style={styles.emptyTitle}>{t.ui.noProductsFoundPromo}</Text>
      <Text style={styles.emptyText}>{t.ui.noDiscountedProducts}</Text>
      <TouchableOpacity
        style={styles.backToPromoButton}
        onPress={() => router.back()}
      >
        <Text style={styles.backToPromoButtonText}>{t.ui.goBack}</Text>
      </TouchableOpacity>
    </View>
  );
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>{t.ui.discountedItems}</Text>
