...
import { getPromotion, getPromotionProducts } from '@/services/api/promotionApi';
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.infoCard}>
                        <View style={styles.infoRow}>
                            ...
                            <Text style={styles.infoValue}>
                                {promotion.applies_to === 'all' ? 'Sitewide' :
                                    promotion.applies_to === 'category' ? 'Category Sale' : 'Product Deal'}
                            </Text>
                        </View>
                    ...
                    {promotion.applies_to === 'products' && products.length > 0 && (
                        <View style={styles.productsSection}>
                            ...
                            <FlatList
                                data={products}
                                renderItem={({ item }) => <ProductCard product={item} onPress={() => router.push(`/products/${item.barcode}` as any)} />}
                                keyExtractor={(item) => (item.id || item.barcode)?.toString() || ''}
                                numColumns={2}
