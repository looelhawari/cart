...
import { MapPin, Plus, Check, Edit2, Trash2, ArrowLeft, Home, Briefcase, MapPinned } from "lucide-react-native";
        ...
        <View key={address.id} style={styles.addressCard}>
            ...
            <View style={styles.addressDetails}>
                ...
                <View style={styles.addressTextContainer}>
                    <MapPin size={16} color={Colors.neutralMedium} style={styles.locationIcon} />
                    <View style={styles.addressText}>
                        <Text style={styles.street}>{address.street}</Text>
                        {(address.building || address.floor || address.apartment) && (
                            <Text style={styles.detailsText}>
                                {[address.building, `Floor ${address.floor}`, `Apt ${address.apartment}`]
                                    .filter(Boolean)
                                    .join(", ")}
                            </Text>
                        )}
