  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {loading ? (
        ...
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <View style={styles.grid}>
            ...
            <StatCard
              ...
              label="Earnings"
              value={`EGP ${parseFloat(stats.total_earnings?.toString() || '0').toFixed(0)}`}
              bg="#fef9c3"
            />
            <StatCard
          ...
          <View style={styles.card}>
            <View style={styles.rateHeader}>
              ...
              <Text style={styles.rateTitle}>Delivery Rate</Text>
            </View>
          ...
          {stats.avg_delivery_time_minutes != null && (
            <View style={styles.card}>
              <View style={styles.rateHeader}>
                ...
                <Text style={styles.rateTitle}>Average Delivery Time</Text>
              </View>
              <Text style={styles.bigNumber}>
                {stats.avg_delivery_time_minutes.toFixed(0)} min
              </Text>
            </View>
          )}
        ...
        <View style={styles.loadingContainer}>
          <Text style={{ color: Colors.neutralMedium }}>No stats available</Text>
        </View>
      )}
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  ...
  rateHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 12 },
  ...
  rateBarFill: { height: '100%', borderRadius: 5, backgroundColor: Colors.primary900 },
  ratePercent: { fontSize: 13, color: Colors.neutralMedium },
  bigNumber: { fontSize: 36, fontWeight: '800', color: '#8b5cf6', marginTop: 4 },
  breakdownTitle: {
    fontSize: 14,
    fontWeight: '700',
  ...
  breakdownCount: { fontSize: 15, fontWeight: '700', color: Colors.neutralCharcoal },
});
