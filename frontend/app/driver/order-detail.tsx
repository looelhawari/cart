      ...
      { text: 'Cancel', style: 'cancel' },
      {
        ...
        onPress: async () => {
          ...
          try {
            ...
            Alert.alert('Error', e.response?.data?.message || 'Failed to reject order');
          } finally {
            setActionLoading(false);
          }
        },
      ...
      { text: 'Cancel', style: 'cancel' },
      {
        ...
        onPress: async () => {
          ...
          try {
            ...
            Alert.alert('Error', e.response?.data?.message || 'Failed to mark as picked up');
          } finally {
            setActionLoading(false);
          }
        },
        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              Alert.alert('Error', e.response?.data?.message || 'Failed to mark as delivered');
            } finally {
              setActionLoading(false);
            }
          },
