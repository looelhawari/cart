...
export default function StaticPageScreen({
    ...
    const getTitle = () => {
        if (page) {
            return isRTL ? page.title_ar : page.title_en;
        }
    ...
    const getContent = () => {
        if (page) {
            return isRTL ? page.content_ar : page.content_en;
        }
        ...
        <SafeAreaView style={styles.container} edges={["top"]}>
                ...
                <View style={[styles.headerContent, isRTL && styles.headerContentRTL]}>
                    ...
                    <View style={styles.headerTextContainer}>
                        ...
                        {page?.last_updated_at && (
                            <View style={[styles.lastUpdatedContainer, isRTL && styles.rowRTL]}>
            ...
            {loading && !refreshing ? (
                ...
                <View style={styles.errorContainer}>
                    <Ionicons name="alert-circle-outline" size={48} color={Colors.danger900 || "#F44336"} />
