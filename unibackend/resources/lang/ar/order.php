...
return [
    ...
    'refund_pending_reconciliation' => 'تم تنفيذ استرداد المبلغ لدى مزوّد الدفع، لكن واجهتنا مشكلة في التحديث الداخلي. تم تنبيه فريقنا وسيتم التسوية قريباً.',
    'store_closed' => 'المتجر مغلق حالياً. يمكنك جدولة الطلب لوقت لاحق.',
