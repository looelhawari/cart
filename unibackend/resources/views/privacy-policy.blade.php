...
<div class="container">
    ...
    <div class="last-updated">
        <strong>Last Updated:</strong> February 26, 2026 &nbsp;|&nbsp; <strong>Effective Date:</strong> February 26, 2026
    </div>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>Name, email, phone, password</td>
                </tr>
                <tr>
                    <td>Processing and delivering orders</td>
                    <td>Address, payment info, order details</td>
                </tr>
                <tr>
                    <td>Real-time delivery tracking</td>
                    <td>Driver location, order status</td>
                </tr>
                <tr>
                    <td>Customer support and complaint resolution</td>
                    <td>Communication data, order history</td>
                </tr>
                <tr>
                    <td>Push notifications (order updates, promotions)</td>
                    <td>Device tokens, notification preferences</td>
                </tr>
                <tr>
                    <td>Personalization and recommendations</td>
                    <td>Purchase history, search queries, preferences</td>
                </tr>
                <tr>
                    <td>Security and fraud prevention</td>
                    <td>IP address, device info, login history</td>
                </tr>
                <tr>
                    <td>Service improvement and analytics</td>
                    <td>Usage data, performance metrics</td>
                </tr>
                <tr>
                    <td>Legal compliance</td>
                    <td>All data as required by applicable laws</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="card">
        ...
        <ul>
            <li><strong>Account data:</strong> Retained while your account is active. Deleted upon account deletion request (see Section 8).</li>
    ...
    <div class="card">
        ...
        <ul>
            ...
            <li><strong>Deletion:</strong> Request complete deletion of your account and associated data (see Section 8).</li>
    ...
    <div class="card">
        ...
        <div class="highlight">
            <p>You can request the deletion of your account and all associated personal data at any time by visiting our <a href="/delete-account">Account Deletion page</a> or through the App under <strong>Profile → Settings</strong>.</p>
        </div>
