...
<h2>1. قبول الشروط</h2>
<p>من خلال الوصول إلى تطبيق CART للهاتف المحمول واستخدامه، فإنك توافق على الالتزام بهذه الشروط والأحكام. إذا كنت لا توافق على أي جزء من هذه الشروط، فلا يجوز لك استخدام خدماتنا.</p>

<h2>2. استخدام الخدمة</h2>
<p>تمنحك CART ترخيصًا محدودًا وغير حصري وغير قابل للتحويل لاستخدام التطبيق لأغراض شخصية غير تجارية. أنت توافق على استخدام التطبيق فقط لأغراض مشروعة ووفقًا لهذه الشروط.</p>
...
<p>لن تكون CART مسؤولة عن أي أضرار غير مباشرة أو عرضية أو خاصة أو تبعية أو عقابية ناتجة عن استخدامك أو عدم قدرتك على استخدام الخدمة.</p>

<h2>11. الملكية الفكرية</h2>
<p>جميع المحتويات والعلامات التجارية والملكية الفكرية في التطبيق مملوكة لـ CART. لا يجوز لك إعادة إنتاج أو توزيع أو إنشاء أعمال مشتقة دون موافقتنا الخطية المسبقة.</p>
...
<h2>خصوصيتك تهمنا</h2>
<p>في CART، نحن ملتزمون بحماية خصوصيتك وضمان أمان معلوماتك الشخصية. توضح سياسة الخصوصية هذه كيفية جمع بياناتك واستخدامها والإفصاح عنها وحمايتها عند استخدام تطبيقنا للهاتف المحمول.</p>
...
HTML;
    ...
    {
        return <<<HTML
<h1>مرحباً بكم في CART</h1>

<h2>من نحن</h2>
<p>CART هو هايبر ماركت إلكتروني موثوق، يقدم لكم المنتجات الطازجة والمستلزمات اليومية مباشرة إلى باب منزلكم. منذ تأسيسنا، التزمنا بجعل تجربة التسوق سهلة وممتعة للعائلات في جميع أنحاء مصر.</p>
...
<h2>لماذا تختارنا</h2>
<p>مع آلاف المنتجات والأسعار التنافسية والتوصيل في أقل من ساعة، CART يجعل تسوق البقالة بسيطاً. فريقنا المتفاني يعمل على مدار الساعة لضمان حصولكم على أفضل تجربة تسوق.</p>
...
<h2>التزامنا</h2>
<p>في CART، نؤمن بأن الجميع يستحق الوصول إلى منتجات بقالة عالية الجودة دون أي متاعب. نعمل باستمرار على تحسين خدماتنا وتوسيع نطاق منتجاتنا وتعزيز تجربة التسوق الخاصة بكم.</p>

<p>شكراً لاختياركم CART. نتطلع لخدمتكم!</p>
HTML;
    }
}
