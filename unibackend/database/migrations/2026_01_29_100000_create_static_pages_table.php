    ...
    public function up(): void
    {
        ...
        DB::table('static_pages')->insert([
            [
                ...
                'content_en' => '<h1>Terms and Conditions</h1><p>Welcome to El Baraka. Please read these terms carefully.</p>',
                'content_ar' => '<h1>الشروط والأحكام</h1><p>مرحباً بكم في البركة. يرجى قراءة هذه الشروط بعناية.</p>',
                'is_active' => true,
                'last_updated_at' => now(),
                'created_at' => now(),
                'updated_at' => now(),
