...
class CheckoutService
{
     ...
     * Process payment.
     *
     * Wallet feature has been removed from the product. Only two payment
     * methods are supported: 'card' (Paymob) or 'cash_on_delivery'. Anything
     * else is rejected.
     *
     * @param Order $order
     * @param string $paymentMethod 'card' | 'cash_on_delivery'
