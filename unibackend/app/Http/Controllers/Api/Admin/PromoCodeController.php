...
class PromoCodeController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'promotional_message_ar' => ['nullable', 'string'],
            'minimum_spend_30days' => ['nullable', 'numeric', 'min:0'],
            'minimum_orders_30days' => ['nullable', 'integer', 'min:0'],
            'last_order_date_from' => ['nullable', 'date'],
            'last_order_date_to' => ['nullable', 'date'],
        ...
        return DB::transaction(function () use ($validated) {
            ...
            $promoCode = PromoCode::create([
                ...
                'promotional_message' => $validated['promotional_message'] ?? null,
                'promotional_message_ar' => $validated['promotional_message_ar'] ?? null,
                'minimum_spend_30days' => $validated['minimum_spend_30days'] ?? null,
                'minimum_orders_30days' => $validated['minimum_orders_30days'] ?? null,
                'last_order_date_from' => $validated['last_order_date_from'] ?? null,
                'last_order_date_to' => $validated['last_order_date_to'] ?? null,
                'registration_date_from' => $validated['registration_date_from'] ?? null,
                'registration_date_to' => $validated['registration_date_to'] ?? null,
                'location' => $validated['location'] ?? null,
                'specific_user_ids' => $validated['specific_user_ids'] ?? null,
            ]);
