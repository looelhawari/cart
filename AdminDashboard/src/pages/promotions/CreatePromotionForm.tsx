...
export default function CreatePromotionForm({ isOpen, onClose }: CreatePromotionFormProps) {
    ...
    const createMutation = useMutation({
        mutationFn: async (data: PromotionFormData) => {
            ...
            return promotionService.createPromotion(submitData, selectedImageFile || undefined, selectedBannerFile || undefined)
        },
        onSuccess: () => {
            ...
            <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800" dir={isRTL ? 'rtl' : 'ltr'}>
                <DialogHeader className="pb-6 border-b border-gray-200 dark:border-gray-700">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <DialogTitle className="text-2xl font-bold bg-gradient-to-r from-elbaraka-primary to-elbaraka-secondary bg-clip-text text-transparent">
                                {t('promotions.createNewPromotion')}
                            </DialogTitle>
                            <p className="text-sm text-gray-500 mt-1">
                                {t('promotions.createPromotionDescription')}
                            </p>
                        </div>
                    </div>
                </DialogHeader>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 pt-6">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                        <div className="flex items-center gap-2 mb-4">
                            <FileText className="h-5 w-5 text-elbaraka-primary" />
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                        <div className="flex items-center gap-2 mb-4">
                            <Percent className="h-5 w-5 text-elbaraka-primary" />
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                        <div className="flex items-center gap-2 mb-4">
                            <Calendar className="h-5 w-5 text-elbaraka-primary" />
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                />
                                <div className="relative">
                                    <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-elbaraka-primary pointer-events-none" />
                                    <Input
                                        id="start_date"
                                        type="datetime-local"
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                        <div className="flex items-center gap-2 mb-4">
                            <Package className="h-5 w-5 text-elbaraka-primary" />
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                        <div className="flex items-center gap-2 mb-4">
                            <ShoppingCart className="h-5 w-5 text-elbaraka-primary" />
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                        <div className="flex items-center gap-2 mb-4">
                            <ImageIcon className="h-5 w-5 text-elbaraka-primary" />
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    className="file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-gradient-to-r file:from-elbaraka-primary file:to-elbaraka-secondary file:text-white"
                                />
                                {selectedImageFile && (
                    ...
                    {/* Status Section */}
                    <div className="bg-gradient-to-br from-elbaraka-primary/10 to-elbaraka-secondary/10 rounded-xl p-6 border border-elbaraka-primary/30">
                        <div className="flex items-center gap-2 mb-4">
                            <Sparkles className="h-5 w-5 text-elbaraka-primary" />
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                    ...
                    <DialogFooter className={`flex justify-end gap-3 pt-6 border-t border-gray-200 dark:border-gray-700 ${isRTL ? 'flex-row-reverse' : ''}`}>
                        ...
                        <Button
                            ...
                            className="px-8 bg-gradient-to-r from-elbaraka-primary to-elbaraka-secondary hover:from-elbaraka-primary/90 hover:to-elbaraka-secondary/90 text-white font-semibold shadow-lg"
                        >
                            {createMutation.isPending ? t('promotions.saving') : t('promotions.createPromotion')}
                        </Button>
                    </DialogFooter>
                </form>
            </DialogContent>
